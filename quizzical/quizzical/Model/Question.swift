...
struct Question: Hashable {
    ...
    Question(questionText: "What character have both Robert Downey Jr. and Benedict Cumberbatch played?", possibleAnswers: ["English", "Spanish", "Chinese", "German"], correctAnswerIndex: 2),
    Question(questionText: "Whcih language has the most native speakers", possibleAnswers: ["Sherlock Holmes", "Larry Paul", "Tony Stark", "Harry Lockhart"], correctAnswerIndex: 2),
